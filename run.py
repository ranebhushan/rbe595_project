...
import src.task_allocation_ACO as ts
import pandas as pd
...
for i in range(2,8):
    ...
    for exp in range(NO_OF_EXPERIMENTS):
        ...
        for i in range(2):
            ...
            system = ts.TaskAllocation(num_robots=gen.num_robots,
            ...
            system.go(num_iterations=2*gen.num_tasks)
            end_time = time.time()
