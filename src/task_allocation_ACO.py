...
import src.generateTestCases as gtc

class Ant:
    """This class represents an ant which is a robot in our case"""
    def __init__(self, 
                 ant_id : int,
...
class TaskAllocation:
    ...
    def go(self, num_iterations : int):
...
if __name__ == "__main__":
    ...
    gen = gtc.CaseGenerator(num_robots, num_tasks, num_skills)

    robot_skill_matrix, task_skill_matrix, task_locations = gen.generate_case()
    ...
    while exit_code == 0:
        ...
        system = TaskAllocation(num_robots=gen.num_robots,
